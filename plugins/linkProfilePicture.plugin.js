...
class linkProfilePicture {
	...
	observer({addedNodes}){
		...
		if(addedNodes[0]&&addedNodes[0].nodeType===Node.ELEMENT_NODE&&addedNodes[0].classList.contains('modal-3c3bKg')&&addedNodes[0].getElementsByClassName('avatar-VxgULZ')[0]){
			var a,parent=addedNodes[0].getElementsByClassName('avatar-3EQepX')[0],child=addedNodes[0].getElementsByClassName('mask-1l8v16')[0],img=addedNodes[0].getElementsByClassName('avatar-VxgULZ')[0];
